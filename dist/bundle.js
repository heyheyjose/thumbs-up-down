...
var Vote = React.createClass({
	...
	awesomeCount: function awesomeCount() {
		this.setState({
			awesome: this.state.awesome + 1
		});
	},

	mehCount: function mehCount() {
		this.setState({
	...
	render: function render() {
		return React.createElement(
			...
			React.createElement(
				"button",
				{ className: "btn btn-danger btn-large", onClick: this.mehCount },
				"Meh.",
...
React.render(React.createElement(Vote, null), document.getElementById('vote-mount'));
